# -*- coding: utf-8 -*-
"""动量轮动策略核心 v5：牛熊开关 + 动量轮动 + 过热快离场。

两层结构, 各司其职:
  体制层: 沪深300ETF 跌破年线(MA250) = 熊市体制, 禁止持股票, 只允许黄金/货币;
          站上 = 牛市体制, 股池正常轮动。专治阴跌市假反弹(2018)与持续熊市(2022)。
  动量层: score = MOM20/VOL20 排名; 进场 MOM20>0; 持仓 MOM20 转负敏感离场;
          轮动需挑战者 MOM20 超持仓 BUFFER。

过热保护(防抛物线顶部, 如2024-10):
  持仓 MOM20 > OVERHEAT(40%) 时进入过热态, 离场条件收紧为 MOM5<0;
  过热态标的(再)进场须 MOM5>0 确认。
"""
